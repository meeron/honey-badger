...
func (c *dataClient) Set(ctx context.Context, in *SetRequest, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (c *dataClient) Delete(ctx context.Context, in *KeyRequest, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (c *dataClient) DeleteByPrefix(ctx context.Context, in *PrefixRequest, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (c *dataClient) SetBatch(ctx context.Context, in *SetBatchRequest, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (UnimplementedDataServer) Set(context.Context, *SetRequest) (*Result, error) {
...
func (UnimplementedDataServer) Delete(context.Context, *KeyRequest) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedDataServer) DeleteByPrefix(context.Context, *PrefixRequest) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteByPrefix not implemented")
}
func (UnimplementedDataServer) SetBatch(context.Context, *SetBatchRequest) (*Result, error) {
...
func (c *dbClient) Create(ctx context.Context, in *CreateDbRequest, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
