...
var file_pb_honey_badger_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xeb, 0x01, 0x0a, 0x0b, 0x48, 0x6f, 0x6e, 0x65, 0x79,
	...
	0x6c, 0x74, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x6d, 0x65, 0x65, 0x72, 0x6f, 0x6e, 0x2f, 0x68, 0x6f, 0x6e, 0x65, 0x79, 0x2d,
	0x62, 0x61, 0x64, 0x67, 0x65, 0x72, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_pb_honey_badger_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pb_honey_badger_proto_goTypes = []interface{}{
	...
	nil,                   // 6: pb.PrefixResult.DataEntry
}
var file_pb_honey_badger_proto_depIdxs = []int32{
	6, // 0: pb.PrefixResult.data:type_name -> pb.PrefixResult.DataEntry
	0, // 1: pb.HoneyBadger.Set:input_type -> pb.SetRequest
	1, // 2: pb.HoneyBadger.Get:input_type -> pb.KeyRequest
	4, // 3: pb.HoneyBadger.GetByPrefix:input_type -> pb.PrefixRequest
	1, // 4: pb.HoneyBadger.Delete:input_type -> pb.KeyRequest
	4, // 5: pb.HoneyBadger.DeleteByPrefix:input_type -> pb.PrefixRequest
	3, // 6: pb.HoneyBadger.Set:output_type -> pb.Result
	2, // 7: pb.HoneyBadger.Get:output_type -> pb.GetResult
	5, // 8: pb.HoneyBadger.GetByPrefix:output_type -> pb.PrefixResult
	3, // 9: pb.HoneyBadger.Delete:output_type -> pb.Result
	3, // 10: pb.HoneyBadger.DeleteByPrefix:output_type -> pb.Result
